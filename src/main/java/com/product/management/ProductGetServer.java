...
public class ProductGetServer {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			HttpServer getServer = HttpServer.create(new InetSocketAddress(9002), 0); //setting port number and backlog, 0 by default(accepts number of connection based on running machine)
			...
			System.out.println("Sever is running in the port 9002 . . .");
